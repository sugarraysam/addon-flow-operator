...
var AllValidators = map[string]utils.Validator{
	...
	"003_csv_names": {
		Name:        "003_csv_names",
		Description: "Validate CSV.name and CSV.replaces against the operatorName and semver check.",
		Runner:      validators.Validate003CSVNames,
	},
	"007_csv_install_modes": {
		Name:        "007_csv_install_modes",
		Description: "Validate CSV.name and CSV.replaces against the operatorName and semver check.",
		Runner:      validators.Validate003CSVNames,
	},
}
